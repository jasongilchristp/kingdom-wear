        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center">
            <button 
              ...
              className="relative p-2 hover:bg-gray-50 rounded-full transition-colors flex items-center justify-center"
            >
              <svg 
              ...
              {cartCount > 0 && (
                <span className="absolute top-0 right-0 inline-flex items-center justify-center min-w-[20px] h-[20px] px-1 text-xs font-bold leading-none text-white bg-black rounded-full transform translate-x-1/4 -translate-y-1/4">
                  {cartCount}
                </span>
              )}
            </button>
